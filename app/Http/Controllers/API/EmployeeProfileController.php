...
{
    // Create Employee Profile (Admin function)
    ...
    // Get specific profile for an employee
    ...
    // Update Employee Profile (User function)
    ...
    // View Employee Profile (User function)
